...
public class SSHClient {
     ...
     *
     * @param user       username used to login to remote machine
     * @param host       IP address of remote machine
     * @param privateKey byte[] pvt key to remote machine
     */
     ...
     * </dd>
     *
     * @param command A unix command to be executed on remote vm e.g 'pwd'
